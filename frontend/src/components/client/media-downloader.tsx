...
export function MediaDownloader({ config }: { config: ProviderConfig }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#eef2ff_0%,#f8fbff_42%,#ffffff_100%)] pb-20 pt-12 dark:bg-[linear-gradient(180deg,#0b1120_0%,#0f172a_45%,#111827_100%)] sm:pb-24 sm:pt-16">
      <div className="hero-orb hero-orb-left" />
      <div className="hero-orb hero-orb-right" />
      <div className="container-page relative">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[36px] border border-white/70 bg-white/85 shadow-[0_30px_90px_rgba(15,23,42,0.10)] ring-1 ring-slate-200/70 backdrop-blur dark:border-slate-800 dark:bg-slate-900/90 dark:ring-slate-800 dark:shadow-none">
          <div className="grid gap-0 lg:grid-cols-[1.18fr_0.82fr]">
            <div className="p-7 sm:p-10 lg:p-12">
              ...
              <h1 className="mt-5 max-w-3xl text-3xl font-black tracking-[-0.03em] text-slate-950 sm:text-5xl">{config.title}</h1>
              ...
              <div className="glass-panel mt-8 rounded-[28px] border border-white/80 bg-gradient-to-br from-white via-indigo-50/70 to-sky-50/80 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] dark:border-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 dark:shadow-none sm:p-6">
                <label className="block text-sm font-black text-slate-900">
                  Dán URL công khai
                  <div className="mt-3 flex flex-col gap-3 sm:flex-row">
                    <div className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm shadow-slate-200/50 dark:border-slate-700 dark:bg-slate-950 dark:shadow-none">
                    ...
                    <button
                      ...
                      className="inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-slate-950 px-6 text-sm font-black text-white shadow-lg shadow-slate-300 transition hover:-translate-y-0.5 hover:bg-slate-900 disabled:cursor-not-allowed disabled:opacity-60"
                    >
              ...
              {resolve.data && (
                <div className="mt-7 space-y-6">
                  <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_20px_50px_rgba(15,23,42,0.06)] dark:border-slate-800 dark:bg-slate-950 dark:shadow-none">
                  ...
                  {([
                    ...
                    return (
                      <div key={kind} className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_18px_45px_rgba(15,23,42,0.05)] dark:border-slate-800 dark:bg-slate-950 dark:shadow-none">
                          ...
                          {items.map((asset) => {
                            ...
                            return (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] px-4 py-4 transition hover:-translate-y-0.5 hover:border-indigo-200 hover:shadow-sm dark:border-slate-800 dark:bg-[linear-gradient(180deg,#111827_0%,#0f172a_100%)] dark:hover:border-indigo-500/50 dark:hover:shadow-none sm:flex-row sm:items-center sm:justify-between"
                              >
            ...
            <div className="border-l border-slate-100 bg-[linear-gradient(180deg,#0f172a_0%,#111c34_100%)] p-7 text-white sm:p-10 lg:p-12">
